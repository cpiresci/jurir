...
const PLANS = [
  {
    ...
    color:    'var(--au6)',
    border:   'var(--b-gold)',
    shadow:   '0 0 30px rgba(180,140,60,0.12)',
    desc:     'Ideal para uso ocasional.',
    features: [
      '1 análise premium completa',
  ...
  },
  {
    ...
    shadow:   '0 0 30px rgba(180,40,40,0.12)',
    badge:    'MAIS POPULAR',
  ...
  },
  {
    ...
    color:    'var(--co7)',
    border:   'var(--b-main)',
    shadow:   '0 0 30px rgba(0,180,220,0.12)',
  ...
  },
  {
    ...
    shadow:   '0 0 30px rgba(0,200,130,0.12)',
    desc:     'Para integração e automação.',
    features: [
      'Tudo do plano Escritório',
      'API Key própria (X-Api-Key)',
      'Webhook outbound',
      'Sandbox de testes',
      'Usuários ilimitados',
      'Suporte prioritário',
...
export default function CheckoutPage() {
  ...
  const handleCheckout = async (planId) => {
    ...
    try {
      const { url } = await createCheckoutSession(authToken, planId);
  ...
  return (
    <div style={{ maxWidth: 1060, margin: '0 auto', padding: '100px 24px 60px' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 52 }}>
        <div style={{ fontSize: '.72rem', color: 'var(--co7)', fontFamily: 'var(--f-mono)',
          letterSpacing: '.15em', marginBottom: 10 }}>PLANOS & PREÇOS</div>
        <h1 className="t-display" style={{ fontSize: 'clamp(1.8rem,4vw,2.8rem)', fontWeight: 700, marginBottom: 14 }}>
          Escolha seu plano
        </h1>
          ...
          return (
            ...
            >
              ...
              <div style={{ marginBottom: 20 }}>
                <span className="t-display" style={{ fontSize: '1.9rem', fontWeight: 700, color: plan.color }}>
                  {plan.price}
                </span>
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${plan.border}`,
                  background: loadingPlan === plan.id ? 'var(--surface)' : 'transparent',

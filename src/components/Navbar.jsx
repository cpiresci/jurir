    ...
    <nav className={`jnav${scrolled ? ' scrolled' : ''}`}>
      ...
      <Link to="/" className="nav-brand">
        ...
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
          ...
          <path d="M7 17 Q9 21 13 21 Q17 21 18 17" stroke="var(--co7)" strokeWidth="1" fill="rgba(0,242,254,0.06)" strokeLinecap="round"/>
          <path d="M18 17 Q19 21 23 21 Q27 21 29 17" stroke="var(--co8)" strokeWidth="1" fill="rgba(0,242,254,0.04)" strokeLinecap="round"/>
          <circle cx="18" cy="9" r="2" fill="var(--co7)"/>
        </svg>
        <span className="nav-wordmark t-display">
          JUR<em>IR</em>
          <sub>INTELIGÊNCIA JURÍDICA POR IA</sub>
        </span>
      </Link>

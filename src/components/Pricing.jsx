    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, marginTop: isPopular ? 18 : 0 }}>
        ...
        <div style={{ marginBottom: 4 }}>
          <span style={{
            fontFamily: 'var(--f-display)', fontSize: 'var(--fs-6xl)', fontWeight: 600, lineHeight: 1,
        ...
        <div style={{ fontFamily: 'var(--f-mono)', fontSize: 'var(--fs-xs)', color: 'var(--t4)', marginBottom: plan.note ? 10 : 20, letterSpacing: '.06em' }}>
          {plan.sub}
        </div>
        {plan.note && (
          <div style={{
            fontFamily: 'var(--f-mono)', fontSize: 'var(--fs-xs)', color: p.badgeColor,
            background: p.badgeBg, border: `1px solid ${p.border}`,
        ...
        <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 9, marginBottom: 24 }}>
          {plan.features.map((f, i) => (
            <li key={i} style={{ display: 'flex', gap: 9, alignItems: 'flex-start' }}>
              ...
              <span style={{ fontSize: 'var(--fs-sm)', color: 'var(--t2)', lineHeight: 1.45 }}>{f}</span>
            </li>
          ))}
        </ul>
        <button
    ...
    <section id="precos" style={{ padding: '100px 24px' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          ...
          <p style={{ color: 'var(--t3)', fontSize: 'var(--fs-base)', lineHeight: 1.7, maxWidth: 520, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, margin: '8px 0 16px' }}>
          ...
          <span style={{ fontFamily: 'var(--f-mono)', fontSize: 'var(--fs-xs)', color: 'var(--t4)', letterSpacing: '.22em', whiteSpace: 'nowrap' }}>

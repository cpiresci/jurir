  ...
  return (
    <section id="analise" style={{ paddingTop: 80 }}>
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '60px 24px 0' }}>
        ...
        {/* Status banner — cooldown/recovery/step tracking */}
          ...
          <div style={{
            ...
            {statusMessage && (
              <>
                ...
                <span style={{ fontSize: '.84rem', color: 'var(--n3)', fontFamily: 'var(--f-sans)', flex: 1 }}>
                  {statusMessage}
                </span>
              </>
            )}
            {tribunal && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginLeft: 'auto' }}>
                <MapPin size={11} style={{ color: 'var(--r3)' }}/>
                <span style={{ fontSize: '.7rem', color: 'var(--r3)', fontFamily: 'var(--f-mono)', letterSpacing: '.06em' }}>
                  {tribunal}
                </span>
              </div>
            )}
